...
#define RX1BF_INT_GPIO_PORT		GPIOG
#define RX1BF_INT_GPIO_CLK_ENABLE()		__GPIOG_CLK_ENABLE();
#define RX1BF_INT_GPIO_PIN				GPIO_PIN_2
...
#define MCP2515_CS_GPIO_PIN			GPIO_PIN_15

#define MCP2515_INT_GPIO_PORT		GPIOG
#define MCP2515_INT_GPIO_CLK_ENABLE()	__GPIOG_CLK_ENABLE()
#define MCP2515_INT_EXTI_IRQ			EXTI1_IRQn

#define MCP2515_INT_GPIO_PIN		GPIO_PIN_2
