...
#define CCP_WORD	1
#define CCP_DWORD	1
#define CCP_BYTEPTR	1
#define CCP_MTABYTEPTR	1
#define CCP_DAQBYTEPTR	1*/

#define CCP_WRITE_EEPROM	1
#define EEPROM_START		(unsigned char *)0
#define EEPROM_END 			(unsigned char *)0xff
