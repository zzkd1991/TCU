...
#define RHEOSTAT_ADC_CHANNEL1				ADC_CHANNEL_11
...
#define RHEOSTAT_ADC_GPIO_PIN4				GPIO_PIN_2
#define RHEOSTAT_ADC_GPIO_CLK4_ENABLE()	__GPIOA_CLK_ENABLE()
#define RHEOSTAT_ADC_CHANNEL4				ADC_CHANNEL_2

//DO_IN2
#define RHEOSTAT_ADC_GPIO_PORT5			GPIOA
#define RHEOSTAT_ADC_GPIO_PIN5				GPIO_PIN_3
...
//AI1
#define _RHEOSTAT_ADC_GPIO_PORT1             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN1              GPIO_PIN_3
#define _RHEOSTAT_ADC_GPIO_CLK1_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL1               ADC_CHANNEL_9


//AI2
#define _RHEOSTAT_ADC_GPIO_PORT2             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN2              GPIO_PIN_4
#define _RHEOSTAT_ADC_GPIO_CLK2_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL2               ADC_CHANNEL_14

//AI3
#define _RHEOSTAT_ADC_GPIO_PORT3				GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN3				GPIO_PIN_5
#define _RHEOSTAT_ADC_GPIO_CLK3_ENABLE()		__GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL3				ADC_CHANNEL_15

//AI4
#define _RHEOSTAT_ADC_GPIO_PORT4             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN4              GPIO_PIN_6
#define _RHEOSTAT_ADC_GPIO_CLK4_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL4               ADC_CHANNEL_4

//AI5
#define _RHEOSTAT_ADC_GPIO_PORT5             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN5              GPIO_PIN_7
#define _RHEOSTAT_ADC_GPIO_CLK5_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL5               ADC_CHANNEL_5

//AI6
#define _RHEOSTAT_ADC_GPIO_PORT6             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN6              GPIO_PIN_8
#define _RHEOSTAT_ADC_GPIO_CLK6_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL6               ADC_CHANNEL_6

//RI1
#define _RHEOSTAT_ADC_GPIO_PORT7             GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN7              GPIO_PIN_9
#define _RHEOSTAT_ADC_GPIO_CLK7_ENABLE()     __GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL7               ADC_CHANNEL_7

//RI2
#define _RHEOSTAT_ADC_GPIO_PORT8				GPIOF
#define _RHEOSTAT_ADC_GPIO_PIN8				GPIO_PIN_10
#define _RHEOSTAT_ADC_GPIO_CLK8_ENABLE()		__GPIOF_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL8				ADC_CHANNEL_8

//RI3
#define _RHEOSTAT_ADC_GPIO_PORT9				GPIOC
#define _RHEOSTAT_ADC_GPIO_PIN9				GPIO_PIN_0
#define _RHEOSTAT_ADC_GPIO_CLK9_ENABLE()		__GPIOC_CLK_ENABLE()
#define _RHEOSTAT_ADC_CHANNEL9				ADC_CHANNEL_10
