...
#define TLE7242_FAULT_INT_GPIO_PORT	GPIOB
#define TLE7242_FAULT_GPIO_CLK_ENABLE()	__GPIOB_CLK_ENABLE();
#define TLE7242_FAULT_PIN	GPIO_PIN_6
#define TLE7242_FAULT_EXTI_IRQ			EXTI9_5_IRQn
#define TLE7242_FAULT_IRQHandler		EXTI9_5_IRQHandler
